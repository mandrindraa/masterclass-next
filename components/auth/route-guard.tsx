...
import { getCurrentUser, getCurrentUserFromCookie, hasRouteAccess } from "@/lib/auth"
...
export function RouteGuard({ children, requiredRole, fallbackPath = "/dashboard" }: RouteGuardProps) {
