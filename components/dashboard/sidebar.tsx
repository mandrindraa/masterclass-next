...
export function Sidebar({ userRole, activeTab, setActiveTab }: SidebarProps) {
  const menuItems = [
    ...
    { id: "classrooms", label: "Classrooms", icon: Building, roles: ["admin", "teacher"] },
    { id: "notes", label: "Notes", icon: FileText, roles: ["admin", "teacher", "student"] },
    { id: "reports", label: "Report Cards", icon: FileBarChart, roles: ["admin", "teacher"] },
  ]
